...
# OG
# possible = 0
# game_lines = input.split("\n")

# game_lines.each do |game_line|
#   game_num = game_line.split(':')[0].split(' ')[1].to_i

#   puts "GAME #{game_num}"
#   valid = true
#   sets = game_line.split(':')[1].split(';').each do |set|
#     blue = 0
#     red = 0
#     green = 0
...
#       num = count.split(' ')[0].strip.to_i
#       color = count.split(' ')[1].strip
#       blue += num if color === 'blue'
#       red += num if color === 'red'
#       green += num if color === 'green'
#     end
...
#   end
#   possible += game_num if valid

#   puts "game #{game_num} valid: #{valid}, new possible: #{possible}"
# end
# puts possible
