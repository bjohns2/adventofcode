  ...
  lines.each_with_index do |line, y|
    ...
    line.split('').each_with_index do |char, x|
      if nums.include?(char)
        current_num += char
        current_num_is_valid = current_num_is_valid || is_adjacent(x,y, input)
      end
      if x+1 == line.size || !nums.include?(line[x+1])
        puts "found #{current_num}, valid #{current_num_is_valid}" if current_num != ''
        valid_numbers << current_num if current_num_is_valid
        current_num = ''
        current_num_is_valid = false
      end
    end
  end
  puts valid_numbers.join(',')
  result = 0
...
def is_adjacent(x,y, input)
  syms = ['$','*','+','#', '%', '@', '!', '-', '/', '\\', '=', '&']
  return true if y-1 >= 0 && x-1 >=0 && syms.include?(input.split("\n")[y-1].split('')[x-1])
  return true if y-1 >= 0 && syms.include?(input.split("\n")[y-1].split('')[x])
  return true if y-1 >= 0 && syms.include?(input.split("\n")[y-1].split('')[x+1])

  return true if  x-1 >=0 && syms.include?(input.split("\n")[y].split('')[x-1])
  return true if syms.include?(input.split("\n")[y].split('')[x+1])

  return true if  x-1 >=0 && input.split("\n")[y+1] && syms.include?(input.split("\n")[y+1].split('')[x-1])
  return true if input.split("\n")[y+1] && syms.include?(input.split("\n")[y+1].split('')[x])
  return true if input.split("\n")[y+1] && syms.include?(input.split("\n")[y+1].split('')[x+1])
