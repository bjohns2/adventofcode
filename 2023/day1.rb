...
lines.each do |line|
  ...
  line.split('').each_with_index do |letter, i|
    puts line
    if line[i..i+2] == 'one'
      first_num = '1' if first_num == nil
      last_num = '1'
    elsif line[i..i+2] == 'two'
      first_num = '2' if first_num == nil
      last_num = '2'
    elsif line[i..i+4] == 'three'
      first_num = '3' if first_num == nil
      last_num = '3'
    elsif line[i..i+3] == 'four'
      first_num = '4' if first_num == nil
      last_num = '4'
    elsif line[i..i+3] == 'five'
      first_num = '5' if first_num == nil
      last_num = '5'
    elsif line[i..i+2] == 'six'
      first_num = '6' if first_num == nil
      last_num = '6'
    elsif line[i..i+4] == 'seven'
      first_num = '7' if first_num == nil
      last_num = '7'
    elsif line[i..i+4] == 'eight'
      first_num = '8' if first_num == nil
      last_num = '8'
    elsif line[i..i+3] == 'nine'
      first_num = '9' if first_num == nil
      last_num = '9'
    elsif line[i..i+3] == 'zero'
        first_num = '0' if first_num == nil
        last_num = '0'
    elsif number.include? letter
      first_num = letter if first_num == nil
      last_num = letter
    end
  end
  result_str = first_num + last_num
  result_num = result_str.to_i
  sum += result_num
end
puts sum
