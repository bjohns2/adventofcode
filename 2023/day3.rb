input = "...788.............................54.........501...........555.........270.................................521......893....................
...
def calc(input)
  nums = [1,2,3,4,5,6,7,8,9,0].map(&:to_s)
  ...
  lines.each_with_index do |line, y|
    ...
    line.split('').each_with_index do |char, x|
      if nums.include?(char)
        current_num += char
        adjacent_gears << gear_adjacent(x,y, input) if gear_adjacent(x,y, input)
      end
      if x+1 == line.size || !nums.include?(line[x+1])
        puts "found #{current_num}, adjacent_gears #{adjacent_gears.uniq}" if current_num != ''
        adjacent_gears.uniq.each do |gear|
          gears[gear] = [] if  gears[gear] == nil
          gears[gear] << current_num
        end
        current_num = ''
        adjacent_gears = []
      end
...
def gear_adjacent(x,y, input)
  syms = ['*']
  return "#{x-1},#{y-1}" if y-1 >= 0 && x-1 >=0 && syms.include?(input.split("\n")[y-1].split('')[x-1])
  return "#{x},#{y-1}" if y-1 >= 0 && syms.include?(input.split("\n")[y-1].split('')[x])
  return "#{x+1},#{y-1}" if y-1 >= 0 && syms.include?(input.split("\n")[y-1].split('')[x+1])

  return "#{x-1},#{y}" if  x-1 >=0 && syms.include?(input.split("\n")[y].split('')[x-1])
  return "#{x+1},#{y}" if syms.include?(input.split("\n")[y].split('')[x+1])

  return "#{x-1},#{y+1}" if  x-1 >=0 && input.split("\n")[y+1] && syms.include?(input.split("\n")[y+1].split('')[x-1])
  return "#{x},#{y+1}" if input.split("\n")[y+1] && syms.include?(input.split("\n")[y+1].split('')[x])
  return "#{x+1},#{y+1}" if input.split("\n")[y+1] && syms.include?(input.split("\n")[y+1].split('')[x+1])

  false
end

# puts is_adjacent(3,1, test_input)
puts calc(input)
