...
simple_test_input_extra_pipe = "-L|F7
7S-7|
L|7||
-L-J|
L|-JF"

complex_test_input = "..F7.
.FJ|.
SJ.L7
|F--J
LJ..."

complex_test_input_extra_pipe = "7-F7-
.FJ|7
SJLL7
|F--J
LJ.LJ"

my_input = "-J.|..|7F-J7.J7F7.-77LJ-FL-F77F77F7|F-FLF7.F.FL7F-J.|.FF7-|-F7F7F7.FF-F7LL7FF-J7.----77-FF-..JF7.L-.FF|-F7--|7F77L7FF77F77.FL-7-L.FL7.FF-7..
...
def find_start_direction(parsed_input, start)
  # puts "up: #{parsed_input[start[0]-1][start[1]]}"
  # puts "down: #{parsed_input[start[0]+1][start[1]]}"
  # puts "left: #{parsed_input[start[0]][start[1]-1]}"
  # puts "right: #{parsed_input[start[0]][start[1]+1]}"
  if ['|', '7', 'F'].include?(parsed_input[start[0]-1][start[1]]) # up
    return [start[0]-1,start[1]]
  elsif parsed_input[start[0]+1] != nil && ['|', 'L', 'J'].include?(parsed_input[start[0]+1][start[1]]) # down
    return [start[0]+1,start[1]]
  elsif ['-', 'F', 'L'].include?(parsed_input[start[0]][start[1]-1]) # left
    return [start[0],start[1]-1]
  elsif ['-', 'J', '7'].include?(parsed_input[start[0]][start[1]+1]) # right
    return [start[0],start[1]+1]
  end
end
