...
def score_trailhead(trailhead, map):
  ...
  if trailhead_score == 9:
    # print('found',trailhead_str(trailhead), 'returning',set([trailhead_str(trailhead)]))
    total_score.add(trailhead_str(trailhead))
    return total_score

  up_trailhead = [trailhead[0]-1,trailhead[1]]
  if is_valid(up_trailhead) and map[up_trailhead[0]][up_trailhead[1]] == trailhead_score + 1:
   total_score = total_score.union(score_trailhead(up_trailhead, map))
  ...
  if is_valid(down_trailhead) and map[down_trailhead[0]][down_trailhead[1]] == trailhead_score + 1:
   total_score = total_score.union(score_trailhead(down_trailhead, map))
  ...
  if is_valid(left_trailhead) and map[left_trailhead[0]][left_trailhead[1]] == trailhead_score + 1:
   total_score = total_score.union(score_trailhead(left_trailhead, map))
  ...
  if is_valid(right_trailhead) and map[right_trailhead[0]][right_trailhead[1]] == trailhead_score + 1:
   total_score = total_score.union(score_trailhead(right_trailhead, map))
...
for trailhead in trailheads:
  total += len(score_trailhead(trailhead, map))
  # print(trailhead, len(score_trailhead(trailhead, map)))
print(total)